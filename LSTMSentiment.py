...
# -*- coding: utf-8 -*-
"""
Created on Sat Dec 19 00:10:11 2020
...
for stock_date in test_dates:
  ...
  if polarity > 0:
    #positive sentiment
    predicted_stock_price[i]=predicted_stock_price[i]*1.001 # increase by 10%
  elif polarity < 0:
    #negative sentiment
    predicted_stock_price[i]=predicted_stock_price[i]*0.009 # decrease by 10%
